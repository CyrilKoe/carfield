...
#define CAR_FP_CLUSTER_PERIPHERAL_CLUSTER_BOOT_CONTROL_REG_ADDR(BASE) (CAR_FP_CLUSTER_PERIPHS_BASE_ADDR(BASE) + SPATZ_CLUSTER_PERIPHERAL_CLUSTER_BOOT_CONTROL_REG_OFFSET) 
#define CAR_FP_CLUSTER_PERIPHERAL_CORESTATUS_REG_ADDR(BASE) (CAR_FP_CLUSTER_PERIPHS_BASE_ADDR(BASE) + SPATZ_CLUSTER_PERIPHERAL_CLUSTER_EOC_EXIT_REG_OFFSET) 
