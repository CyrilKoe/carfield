...
extern volatile struct mboxes   *g_mboxes;
 ...
 */
static inline void rb_init(volatile struct ring_buf *rb, uint64_t size,
...
static __attribute__((optnone)) void csleep(uint32_t cycles) {
