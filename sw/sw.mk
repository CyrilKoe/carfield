...
CAR_SW_LIBS = $(CAR_SW_DIR)/lib/libcarfield.a $(CAR_SW_DIR)/deps/riscv-iommu-tests/build/cva6/rv_iommu_test.a
...
CAR_SW_TEST_SRCS_C	= $(filter-out $(CAR_ELFLOAD_BLOCKING_SAFED_SRC_C) $(CAR_ELFLOAD_BLOCKING_SPATZD_SRC_C) $(CAR_ELFLOAD_BLOCKING_PULPD_SRC_C) $(CAR_ELFLOAD_PULPD_INTF_SRC_C), $(wildcard $(CAR_SW_DIR)/tests/bare-metal/hostd/*.c))
