...
cheshire_axi_ext_mst_req_t [cheshire_pkg::iomsb(Cfg.AxiExtNumMst):0] axi_ext_mst_pre_mmu_req, axi_ext_mst_post_mmu_req;
cheshire_axi_ext_mst_rsp_t [cheshire_pkg::iomsb(Cfg.AxiExtNumMst):0] axi_ext_mst_pre_mmu_rsp, axi_ext_mst_post_mmu_rsp;

// All external interrupt (dirty fix to add iommu irqs too)
parameter IOMMU_N_INT_VEC = 8;
logic [cheshire_pkg::iomsb(Cfg.NumExtInIntrs):0] intr_ext_fixme;
...
generate
  if( carfield_configuration::SpatzIOMMUEnable ) begin: gen_spatz_iommu
    ...
    assign intr_ext_fixme = {intr_iommu, intr_ext_i[cheshire_pkg::iomsb(Cfg.NumExtInIntrs)-IOMMU_N_INT_VEC:0]};
